        ...
        </motion.a>
        {
          scrollPosition == 0 && 
            <>
              ...
              <motion.h3 className='quote' animate={scrollPosition == 0 ? {} : {}}>Word in a beautiful wrapper might be the thing that touches humans soul </motion.h3>
            </>
        }
        {
          userData.username ? 
          ...
          :
            <motion.a animate={scrollPosition == 0 ? {backgroundColor: "#EAE7DC", color: "#E85A4F"} : {}} href='/login' className='login'>Log in</motion.a>
        }
    </motion.div>
  )
}
